...
Class Math is defined in package java.lang. Classes in that package are imported automatically,
so you do not need to import class Math to use it.]
Use the following formulas (r is the radius):
diameter = 2r circumference = 2πr area = πr2 Do not store the results of each calculation in a variable.
...
ANSWER: */
    ...
    public static void main(String[]args){
        ...
        System.out.printf("The circumfernce of the circle is %f%n ", circumference);
